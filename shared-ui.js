...
const LANG = {
  fr: {
    ...
    dom_opt_choose:'Choisir (optionnel)',
    dom_opt1:'Anxiété & stress', dom_opt2:'Solitude & isolement',
    dom_opt3:'Relations & famille', dom_opt4:'Travail & burn-out',
    dom_opt5:'Deuil & perte', dom_opt6:'Général (tous sujets)',
    charte_title:'Charte éthique — Bénévole Écoute Anonyme',
    charte_li1:"Je m'engage à offrir une écoute bienveillante, sans jugement ni pression, à toute personne qui me contacte.",
    charte_li2:"Je ne demanderai jamais d'argent, de coordonnées bancaires, ni aucune contrepartie financière à un utilisateur, sous quelque forme que ce soit.",
    charte_li3:"Je ne demanderai pas d'informations personnelles (numéro de téléphone, adresse, identité réelle) à l'utilisateur — sauf si celui-ci les partage spontanément de son propre chef.",
    charte_li4:"Je respecterai l'anonymat de chaque personne et je n'essaierai pas de l'identifier.",
    charte_li5:"Je ne proposerai ni n'établirai de relation personnelle en dehors de la plateforme.",
    charte_li6:"Je ne fournirai pas de conseils médicaux, psychologiques ou juridiques, et je redirigerai vers les services compétents si nécessaire (15, 17, 18, 3114).",
    charte_li7:'Je maintiendrai un comportement respectueux et professionnel en toute circonstance.',
    charte_li8:'Je comprends que tout manquement à cette charte peut entraîner la suspension ou le bannissement de mon compte.',
    vol_status_online:'En ligne', vol_status_away:'Absent·e', vol_status_offline:'Hors ligne',
    vol_since_prefix:'Bénévole depuis ',
    vol_date_locale:'fr-FR',
    benv_empty_text:'Aucun bénévole disponible pour le moment.',
    benv_empty_link:"Rejoindre l'équipe →",
    benv_load_error:'Impossible de charger la liste des bénévoles.',
    form_err_required:'Veuillez remplir tous les champs obligatoires et accepter la charte.',
    form_err_dispo:'Veuillez sélectionner au moins une disponibilité.',
    form_sending:'Envoi en cours…',
    form_success_title:'Votre candidature a bien été envoyée !',
    form_success_text:"Notre équipe l'examinera dans un délai de 5 à 10 jours ouvrés. Vous recevrez une réponse à l'adresse <strong>{{email}}</strong>.",
    form_err_generic:"Une erreur est survenue lors de l'envoi. Merci de réessayer, ou de nous contacter directement.",
    ...
    conf_never_item1:'Nom ou prénom réel', conf_never_item2:'Adresse email',
    conf_never_item3:'Numéro de téléphone', conf_never_item4:'Adresse postale ou toute donnée de localisation',
    conf_only:'Les seules données susceptibles d\'être traitées :',
    conf_only_item1:"Pseudonyme librement choisi par l'utilisateur",
    conf_only_item2:'Contenu des échanges (uniquement si l\'utilisateur choisit de les conserver)',
    conf_only_item3:"Avis anonymes laissés volontairement en fin d'échange",
    ...
    conf_art2_item1:'Permettre les échanges entre utilisateurs et bénévoles',
    conf_art2_item2:'Améliorer la qualité du service grâce aux avis anonymes',
    ...
    conf_art3_item1:"Conversations supprimées immédiatement si l'utilisateur le choisit",
    conf_art3_item2:'Si conservées, accessibles uniquement aux personnes concernées',
    conf_art3_item3:'Suppression totale possible à tout moment sur simple demande',
    ...
    conf_art4_item1:'Sécurisation des échanges (chiffrement en transit)',
    conf_art4_item2:'Protection des données contre tout accès non autorisé',
    conf_art4_item3:'Révision régulière des mesures de sécurité',
    ...
    conf_art5_item1:'Données jamais vendues à des tiers',
    conf_art5_item2:'Données jamais cédées à des partenaires commerciaux',
    conf_art5_item3:'Données jamais utilisées à des fins publicitaires',
  ...
  en: {
    ...
    dom_opt_choose:'Choose (optional)',
    dom_opt1:'Anxiety & stress', dom_opt2:'Loneliness & isolation',
    dom_opt3:'Relationships & family', dom_opt4:'Work & burnout',
    dom_opt5:'Grief & loss', dom_opt6:'General (all topics)',
    charte_title:'Ethics charter — Écoute Anonyme volunteer',
    charte_li1:'I commit to offering caring, judgment-free listening, without pressure, to anyone who contacts me.',
    charte_li2:'I will never ask a user for money, bank details, or any financial compensation, in any form whatsoever.',
    charte_li3:'I will not ask the user for personal information (phone number, address, real identity) — unless they share it spontaneously on their own.',
    charte_li4:"I will respect each person's anonymity and will not attempt to identify them.",
    charte_li5:'I will not propose or establish a personal relationship outside the platform.',
    charte_li6:'I will not provide medical, psychological or legal advice, and will redirect to the appropriate services if necessary (15, 17, 18, 3114).',
    charte_li7:'I will maintain respectful and professional behavior at all times.',
    charte_li8:'I understand that any breach of this charter may result in the suspension or banning of my account.',
    vol_status_online:'Online', vol_status_away:'Away', vol_status_offline:'Offline',
    vol_since_prefix:'Volunteer since ',
    vol_date_locale:'en-US',
    benv_empty_text:'No volunteers available at the moment.',
    benv_empty_link:'Join the team →',
    benv_load_error:'Unable to load the volunteer list.',
    form_err_required:'Please fill in all required fields and accept the charter.',
    form_err_dispo:'Please select at least one availability slot.',
    form_sending:'Sending…',
    form_success_title:'Your application has been successfully sent!',
    form_success_text:'Our team will review it within 5 to 10 business days. You will receive a response at <strong>{{email}}</strong>.',
    form_err_generic:'An error occurred while sending. Please try again, or contact us directly.',
    ...
    conf_never_item1:'Real first or last name', conf_never_item2:'Email address',
    conf_never_item3:'Phone number', conf_never_item4:'Postal address or any location data',
    conf_only:'The only data that may be processed:',
    conf_only_item1:'Username freely chosen by the user',
    conf_only_item2:'Content of exchanges (only if the user chooses to keep them)',
    conf_only_item3:'Anonymous reviews voluntarily left at the end of an exchange',
    ...
    conf_art2_item1:'Enable exchanges between users and volunteers',
    conf_art2_item2:'Improve service quality through anonymous reviews',
    ...
    conf_art3_item1:'Conversations deleted immediately if the user chooses to',
    conf_art3_item2:'If kept, accessible only to the people involved',
    conf_art3_item3:'Full deletion possible at any time upon simple request',
    ...
    conf_art4_item1:'Secured exchanges (encryption in transit)',
    conf_art4_item2:'Data protection against unauthorized access',
    conf_art4_item3:'Regular review of security measures',
    ...
    conf_art5_item1:'Data never sold to third parties',
    conf_art5_item2:'Data never transferred to commercial partners',
    conf_art5_item3:'Data never used for advertising purposes',
